...
# ------------------------------------------------------------
FONT_PATHS = {
    "Rail Thin": "fonts/DejaVuSansCondensed.ttf",
    "Rail Regular": "fonts/DejaVuSans.ttf",
    "Title Thin": "fonts/DejaVuSansCondensed.ttf",
...
PRESETS = {
    "Leica Rail": {
        ...
        "bottom_bar_text_scale": 0.018,
        "location_size": 42,
        "subtitle_size": 22,
        "metadata_text_color": "#B0B0B0",
        "metadata_bg_color": "#000000",
        "location_text_color": "#F5F5F5",
    ...
    "Sony Royal": {
        ...
        "exif_tracking": 0,
        "rail_text_scale": 1.00,
        "bottom_bar_text_scale": 0.020,
        "location_size": 34,
        "subtitle_size": 18,
        "metadata_text_color": "#A0A0A0",
        "metadata_bg_color": "#000000",
        "location_text_color": "#FFFFFF",
        "subtitle_text_color": "#D6D6D6",
        "location_opacity": 0.90,
        "rail_width_ratio": 0.028,
        "bar_height_ratio": 0.048,
        "safe_ratio": 0.92,
        "top_margin": 0.025,
        "title_gap": 10,
        "show_top_plate": True,
...
def get_font(size: int, font_key: str) -> ImageFont.FreeTypeFont:
    path = FONT_PATHS.get(font_key, FONT_PATHS["Rail Regular"])
    try:
...
def render_left_rail(img, text, tracking, rail_width_ratio, rail_text_scale, text_color, rail_color, safe_ratio, font_key):
    ...
    # Key fix: this size is now independently adjustable
    ...
    while font_size > 8:
        ...
        tw = bbox[2] - bbox[0]  # length after rotation
        th = bbox[3] - bbox[1]  # thickness inside rail
...
# ------------------------------------------------------------
st.title("LensRail")
st.caption("Premium V1.2 — Leica Rail and Sony Royal only.")
...
if uploaded_file:
    ...
    with st.sidebar:
        ...
        bottom_bar_text_scale = st.slider("Bar text size", 0.010, 0.040, preset["bottom_bar_text_scale"], 0.001)
    ...
    st.info("Upload one image to start.")